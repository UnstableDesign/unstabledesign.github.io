(function (global, factory) {
    ...
    function firebaseListObservable(ref, _a) {
        ...
        return operators.observeOn.call(listObs, new core.NgZone({}).run(function () { return new fire.ɵZoneScheduler(Zone.current); }));
    }
    ...
    function FirebaseObjectFactory(ref, _a) {
        ...
        return operators.observeOn.call(objectObservable, new core.NgZone({}).run(function () { return new fire.ɵZoneScheduler(Zone.current); }));
    }
