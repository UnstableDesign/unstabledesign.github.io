...
export default createBuilder((options, context) => __awaiter(this, void 0, void 0, function* () {
    ...
    const firebaseProject = getFirebaseProjectName(context.workspaceRoot, context.target.project);
    const buildTarget = options.buildTarget || `${context.target.project}:build:production`;
    try {
        yield deploy(require("firebase-tools"), context, path.join(context.workspaceRoot, project.root), buildTarget, firebaseProject);
    }
    catch (e) {
