...
export default function deploy(firebaseTools, context, projectRoot, buildTarget, firebaseProject) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const run = yield context.scheduleTarget(targetFromTargetString(buildTarget));
        yield run.result;
        try {
